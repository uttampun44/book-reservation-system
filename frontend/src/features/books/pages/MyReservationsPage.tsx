            ...
            {reservedBooks.map((item) => (
              ...
              >
                <div 
                  ...
                  style={{ backgroundColor: item.bookDetails?.coverColor || "#f3f4f6" }}
                >
                  <img 
                    src={item.bookDetails?.coverImage?.medium || item.bookDetails?.imageUrl} 
                ...
                <div className="flex-1 flex flex-col py-1">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <p className="text-gray-500 font-medium">{item.bookDetails?.author}</p>
                    </div>
                    <button 
                      onClick={() => handleUnreserve(item.bookId)}
                      disabled={loading}
                ...
                <div 
                  ...
                  style={{ backgroundColor: item.bookDetails?.coverColor || "#1a2e1a" }}
                />
              </div>
            ))}
          </div>
